...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
         ...
         */
        // TODO - You fill in here.
        private SimpleSemaphore acquireSem;
        private SimpleSemaphore releaseSem;
        ...
        public PlayPingPongThread(String stringToPrint,
                                  ...
                                  int maxIterations) {
            // TODO - You fill in here.
        	this.msg = stringToPrint;
        	this.acquireSem = semaphoreOne;
        	this.releaseSem = semaphoreTwo;
        ...
        private void acquire() {
            // TODO fill in here
    		acquireSem.acquireUninterruptibly();
        }
    ...
    public static void process(String startString, 
        ...
        PlayPingPongThread ping = new PlayPingPongThread(/* TODO - You fill in here */
												pingString, pingSema, pongSema, maxIterations);
        PlayPingPongThread pong = new PlayPingPongThread(/* TODO - You fill in here */
